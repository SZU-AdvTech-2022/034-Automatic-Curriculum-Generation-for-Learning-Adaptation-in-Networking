...
def main():
    ...
    log_path = os.path.join( summary_dir, 'log_sim_adr_{}_{}'.format( args.log_str ,all_file_names[net_env.trace_idx] ) )
        ...
        while True:  # serve video forever
            ...
            if end_of_video:
                ...
                log_path = os.path.join(
                    summary_dir ,
                    'log_sim_adr_{}_{}'.format(args.log_str,  all_file_names[net_env.trace_idx] ) )
                log_file = open( log_path ,'w' )
