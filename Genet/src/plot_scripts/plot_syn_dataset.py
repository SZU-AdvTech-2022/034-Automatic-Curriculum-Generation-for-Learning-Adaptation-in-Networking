...
def main():
    save_dirs = []
    dataset = SyntheticDataset.load_from_dir('/work/lyx/Genet/Genet/data/cc/synthetic_dataset')
    save_dirs = [os.path.join('/work/lyx/Genet/Genet/results/cc/evaluate_synthetic_dataset', 'trace_{:05d}'.format(i))
    ...
    print(udr1_rewards[0],udr1_rewards_err, udr2_rewards[0],udr2_rewards_err,udr3_rewards[0],udr3_rewards_err,genet_bbr_old_rewards[0], genet_bbr_old_rewards_err)
    # fig = plt.figure()
    # ax = plt.gca()
    ...
    # fig.savefig('/work/lyx/Genet/Genet/fig_reproduce/fig9/fig9_cc.png', bbox_inches='tight')
