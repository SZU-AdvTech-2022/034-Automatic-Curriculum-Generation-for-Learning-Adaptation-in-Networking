...
SAVE_DIR  = "/work/lyx/Genet/Genet/results/cc/learning_curve"
...
def main():
    dataset = SyntheticDataset.load_from_dir('/work/lyx/Genet/Genet/data/cc/learning_curve')
    ...
    os.makedirs('/work/lyx/Genet/Genet/fig_reproduce/fig18', exist_ok=True)
    plt.savefig('/work/lyx/Genet/Genet/fig_reproduce/fig18/fig18_cc.png')
